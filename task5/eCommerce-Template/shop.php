    ...
    if (isset($_GET['subcategory'])) {
        if (is_numeric($_GET['subcategory'])) {
            ...
            if ($subResult->num_rows == 1) {
                ...
                $proResult = $pro->getProductBYSub()->get_result();
            } else {
        ...
        if (is_numeric($_GET['brand'])) {
            $brand = new Brand;
            $pro->setId($_GET['brand']);
            $brandResult = $pro->find()->get_result();
            if ($brandResult->num_rows == 1) {
                $pro->setBrand_id($_GET['brand']);
                $proResult = $pro->getProductBYBrand()->get_result();
            } else {
                include "layouts/errors/404.php";
                die;
            }
        ...
        if (is_numeric($_GET['category'])) {
            $categ = new Category;
            $categ->setId($_GET['category']);
            $catResult = $categ->find()->get_result();
