...
$categories = $category->all()->get_result();
                                        ...
                                        <ul class="mega-menu">
                                            <?php if (!empty($allCategories)) {
                                                foreach ($categories as $categ) {             ?>
                                                    <li>
                                                        <ul>
                                                            <li class="mega-menu-title "><a href="shop.php?category=<?= $categ['id'] ?>"><?= $categ['name_en'] ?></a></li>
                                                            <?php $subcategory->setCategory_id($categ['id']);
