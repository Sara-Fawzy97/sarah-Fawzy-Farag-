...
class User extends Model implements ConnectTo
{
    ...
    public function insert(){
        $query="INSERT INTO". self::table. "( firstname,lastname,email,password,phone,gender,code) VALUES(?,?,?,?,?,?,?)";
        $stmt=$this->con->prepare($query);
        $stmt->bind_param('ssssssi',$this->first_name, $this->last_name, $this->email, $this->password,$this->phone,$this->gender,$this->code);
        $stmt->execute();
        return $stmt;
    }
